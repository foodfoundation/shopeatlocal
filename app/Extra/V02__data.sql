...
SELECT 1, '2025-02-21 00:00:00', '2025-02-22 00:00:00', '2025-02-24 00:00:00', '2025-02-25 00:00:00', '2025-02-27 00:00:00', '2025-02-28 00:00:00', '2025-03-01 00:00:00', '2025-03-04 00:00:00'
FROM dual
WHERE NOT EXISTS (SELECT 1 FROM `Cyc`);

INSERT INTO `Cyc` (`IDCyc`, `WhenStartCyc`, `WhenStartShop`, `WhenEndShop`, `WhenStartDeliv`, `WhenEndDeliv`, `WhenStartPickup`, `WhenEndPickup`, `WhenEndCyc`)
SELECT 2, '2025-03-04 00:00:00', '2025-03-05 00:00:00', '2025-03-07 00:00:00', '2025-03-08 00:00:00', '2025-03-10 00:00:00', '2025-03-11 00:00:00', '2025-03-15 00:00:00', '2025-03-17 00:00:00'
FROM dual
...
SELECT 'admin','$2a$10$JeeTocTA5UtE5.QsnXLxk.zAiJqBniyU4SYgdUQYSyIKkm7pqzPhC','Approv','Avail','Avail','StaffSuper','CENTRAL','Admin','User','Yes Street','Aux','AK','12341',1,'5555559999','admin@example.com',1,1,1,1,'Flyer','admin','2025-02-27 10:20:23'
FROM dual
