...
async function wProducts(aIDProducer, aIsMembEbtEligable) {
  ...
  const oSQL = `SELECT zProductAvail.*,
		...
		FROM (
			SELECT SUM(Vty.QtyOffer) AS QtyOfferWebProduct,
				...
				Product.IDProduct, 0 AS Score,
				Product.NameProduct, Product.Descrip, Product.NameImgProduct,
				Product.CkAttrVegan, Product.CkAttrVeget, Product.CkAttrGlutenFreeCert,
				Product.CkAttrFairTradeCert, Product.CkAttrOrganCert,
				Product.CkAttrNaturGrownCert, Product.CkAttrNaturGrownSelf,
				Product.CkAttrIntegPestMgmtSelf, Product.CkAttrAnimWelfareCert,
				Product.CkAttrFreeRgSelf, Product.CkAttrCageFreeSelf,
				Product.CkAttrGrassFedSelf, Product.CkAttrHormAntibFreeSelf,
				Product.WhenCreate,
				Producer.IDProducer, Producer.NameBus, Producer.NameImgProducer,
